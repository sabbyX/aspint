import { ConnectResult, Options } from 'puppeteer-real-browser';
/**
...
export default abstract class ConcurrencyImplementation {
     ...
     */
    constructor(options: Options, puppeteer: any);
    /**
     ...
     */
    abstract workerInstance(perBrowserOptions: Options | undefined): Promise<WorkerInstance>;
}
/**
...
export type ConcurrencyImplementationClassType = new (options: Options, puppeteer: any) => ConcurrencyImplementation;
