    ...
    return (
        <div className="flex items-center justify-center h-full space-x-10">
            {["London", "Manchester", "Edinburgh"].map((center) => (
                <Card
                    key={center}
                    className="flex items-center justify-center min-w-[200px] min-h-[200px] hover:shadow-2xl hover:ring-4 hover:ring-blue-500 transition duration-400 hover:cursor-pointer dark:hover:scale-110 transform duration-200 ease-in"
